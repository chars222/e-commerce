  ...
  return (
    <>
      <section className="relative h-[90vh] w-full bg-slate-900 overflow-hidden flex items-center justify-center">
        <img src="https://api.centralmoda.store/uploads/img-1775871259643-383914535.webp?auto=format&fit=crop&q=80&w=2000" alt="Hero Fashion" className="absolute inset-0 w-full h-full object-cover opacity-60" />
